...
// #define SONAR_TRIG_DDR DDRC
// #define SONAR_TRIG_PORT PORTC
// #define SONAR_TRIG_PIN PC2
// #define SONAR_ECHO_DDR DDRL
// #define SONAR_ECHO_PORT PORTL
// #define SONAR_ECHO_PIN PL2
